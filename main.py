...
def process_image_for_upload(image_content: bytes,
                             coach_id: str) -> Tuple[bytes, bytes, str]:
...
async def upload_to_supabase_storage(supabase_client, content: bytes,
    ...
    try:
        ...
        url_response = supabase_client.storage.from_(
            "transformations").get_public_url(filename)
...
GYMS_DATABASE = [
    ...
    {
        "id": "bf_coigniere",
        "name": "Basic-Fit Coignières",
        "chain": "Basic-Fit",
        "lat": 48.7392,
        "lng": 1.9127,
        "address": "Centre Commercial Auchan, 78310 Coignières",
        "city": "Coignières"
    },
    {
        "id": "bf_plaisir",
        "name": "Basic-Fit Plaisir",
        "chain": "Basic-Fit",
        "lat": 48.8247,
        "lng": 1.9504,
        "address": "Avenue du Général de Gaulle, 78370 Plaisir",
        "city": "Plaisir"
    },
    {
        "id": "bf_versailles",
        "name": "Basic-Fit Versailles",
        "chain": "Basic-Fit",
        "lat": 48.8014,
        "lng": 2.1301,
        "address": "Boulevard de la Reine, 78000 Versailles",
        "city": "Versailles"
    },
    {
        "id": "fp_saint_quentin",
        "name": "Fitness Park Saint-Quentin-en-Yvelines",
        "chain": "Fitness Park",
        "lat": 48.7838,
        "lng": 2.0482,
        "address": "Place Georges Pompidou, 78180 Montigny-le-Bretonneux",
        "city": "Montigny-le-Bretonneux"
    },
    {
        "id": "fp_velizy",
        "name": "Fitness Park Vélizy",
        "chain": "Fitness Park",
        "lat": 48.7804,
        "lng": 2.1889,
    ...
    {
        "id": "bf_trappes",
        "name": "Basic-Fit Trappes",
        "chain": "Basic-Fit",
        "lat": 48.7765,
        "lng": 2.0079,
        "address": "Centre Commercial Auchan, 78190 Trappes",
        "city": "Trappes"
    },
    {
        "id": "keep_cool_mantes",
        "name": "Keep Cool Mantes-la-Jolie",
        "chain": "Keep Cool",
        "lat": 49.0014,
        "lng": 1.7168,
        "address": "Avenue du Maréchal Juin, 78200 Mantes-la-Jolie",
        "city": "Mantes-la-Jolie"
    },
    {
        "id": "l_orange_bleue_rambouillet",
        "name": "L'Orange Bleue Rambouillet",
        "chain": "L'Orange Bleue",
        "lat": 48.6436,
        "lng": 1.8287,
        "address": "Zone d'activité des Closeaux, 78120 Rambouillet",
        "city": "Rambouillet"
    },
    ...
    {
        "id": "club_med_gym_rivoli",
        "name": "Club Med Gym Rivoli",
        "chain": "Club Med Gym",
        "lat": 48.8606,
        "lng": 2.3376,
    ...
    {
        "id": "cmg_one_marais",
        "name": "CMG Sports Club One Marais",
        "chain": "CMG Sports Club",
        "lat": 48.8566,
        "lng": 2.3522,
    ...
    {
        "id": "fp_paris_theatre",
        "name": "Fitness Park Paris-Théâtre",
        "chain": "Fitness Park",
        "lat": 48.8407,
        "lng": 2.2936,
        "address": "104 bis rue du Théâtre, 75015 Paris",
        "city": "Paris"
    },
    {
        "id": "keepcool_paris15",
        "name": "Keepcool Paris 15 Convention",
        "chain": "Keep Cool",
        "lat": 48.8423,
        "lng": 2.2963,
        "address": "59 Rue Gutenberg, 75015 Paris",
        "city": "Paris"
    },
    {
        "id": "neoness_motte_picquet",
        "name": "Neoness La Motte-Picquet",
        "chain": "Neoness",
        "lat": 48.8506,
        "lng": 2.3026,
        "address": "15 rue de La Motte-Picquet, 75015 Paris",
        "city": "Paris"
    },
    {
        "id": "cmg_grenelle",
        "name": "CMG Sports Club One Grenelle",
        "chain": "CMG Sports Club",
        "lat": 48.8450,
        "lng": 2.2985,
        "address": "8 rue Frémicourt, 75015 Paris",
        "city": "Paris"
    },
    {
        "id": "cercles_porte_versailles",
        "name": "Cercles de la Forme Porte de Versailles",
        "chain": "Cercles de la Forme",
        "lat": 48.8353,
        "lng": 2.2886,
        "address": "31, rue du Hameau, 75015 Paris",
        "city": "Paris"
    },
    {
        "id": "front_de_seine",
        ...
        "lat": 48.8487,
        "lng": 2.2835,
        "address": "44 rue Émeriau, 75015 Paris",
        "city": "Paris"
    },
    {
        "id": "cmg_trocadero",
        "name": "CMG Sports Club One Trocadéro",
        "chain": "CMG Sports Club",
        "lat": 48.8620,
        "lng": 2.2870,
        "address": "35 avenue Kléber, 75016 Paris",
        "city": "Paris"
    },
    {
        "id": "fitness_park_ternes",
        "name": "Fitness Park Ternes",
        "chain": "Fitness Park",
        "lat": 48.8783,
        "lng": 2.2967,
        "address": "208 rue de Courcelles, 75017 Paris",
        "city": "Paris"
    },

    # PARIS EST - 19ème, 20ème arrondissements
    {
        "id": "keep_cool_belleville",
        "name": "Keep Cool Belleville",
        "chain": "Keep Cool",
        "lat": 48.8728,
        "lng": 2.3831,
        "address": "52 rue de Belleville, 75019 Paris",
        "city": "Paris"
    },
    {
        "id": "neoness_pere_lachaise",
        "name": "Neoness Père Lachaise",
        "chain": "Neoness",
        "lat": 48.8566,
        "lng": 2.3915,
        "address": "147 avenue Parmentier, 75020 Paris",
        "city": "Paris"
    },
    {
        "id": "forest_hill_menilmontant",
        "name": "Forest Hill Ménilmontant",
        "chain": "Forest Hill",
        "lat": 48.8642,
        "lng": 2.3855,
        "address": "17 rue Boyer, 75020 Paris",
        "city": "Paris"
    },
    ...
    {
        "id": "neoness_defense",
        "name": "Neoness La Défense",
        "chain": "Neoness",
        "lat": 48.8922,
        "lng": 2.2359,
        "address": "CNIT, 92800 Puteaux",
        "city": "Puteaux"
    },
    {
        "id": "cmg_neuilly",
        "name": "CMG Sports Club One Neuilly",
        "chain": "CMG Sports Club",
        "lat": 48.8846,
        "lng": 2.2686,
        "address": "12 rue Madeleine Michelis, 92200 Neuilly-sur-Seine",
        "city": "Neuilly-sur-Seine"
    },
    {
        "id": "fitness_park_boulogne",
        "name": "Fitness Park Boulogne",
        "chain": "Fitness Park",
        "lat": 48.8392,
        "lng": 2.2402,
        "address": "133 route de la Reine, 92100 Boulogne-Billancourt",
        "city": "Boulogne-Billancourt"
    },
    {
        "id": "keep_cool_issy",
        "name": "Keep Cool Issy-les-Moulineaux",
        "chain": "Keep Cool",
        "lat": 48.8267,
        "lng": 2.2725,
        "address": "2 rue Rouget de Lisle, 92130 Issy-les-Moulineaux",
        "city": "Issy-les-Moulineaux"
    },

    # SEINE-SAINT-DENIS (93)
    {
        "id": "basic_fit_bobigny",
        "name": "Basic-Fit Bobigny",
        "chain": "Basic-Fit",
        "lat": 48.9127,
        "lng": 2.4494,
        "address": "Centre Commercial Bobigny 2, 93000 Bobigny",
        "city": "Bobigny"
    },
    {
        "id": "fitness_park_saint_denis",
        "name": "Fitness Park Saint-Denis",
        "chain": "Fitness Park",
        "lat": 48.9362,
        "lng": 2.3574,
        "address": "8 rue du Landy, 93200 Saint-Denis",
        "city": "Saint-Denis"
    },
    {
        "id": "keep_cool_montreuil",
        "name": "Keep Cool Montreuil",
        "chain": "Keep Cool",
        "lat": 48.8644,
        "lng": 2.4530,
        "address": "128 avenue de la Résistance, 93100 Montreuil",
        "city": "Montreuil"
    },

    # VAL-DE-MARNE (94)
    {
        "id": "basic_fit_creteil",
        "name": "Basic-Fit Créteil",
        "chain": "Basic-Fit",
        "lat": 48.7900,
        "lng": 2.4656,
    ...
    {
        "id": "fitness_park_vincennes",
        "name": "Fitness Park Vincennes",
        "chain": "Fitness Park",
        "lat": 48.8467,
        "lng": 2.4378,
        "address": "43 rue de Fontenay, 94300 Vincennes",
        "city": "Vincennes"
    },

    # NORD (59) - Lille et région
    {
        "id": "basic_fit_lille_centre",
        "name": "Basic-Fit Lille Centre",
        "chain": "Basic-Fit",
        "lat": 50.6292,
        "lng": 3.0573,
        "address": "15 rue Nationale, 59000 Lille",
        "city": "Lille"
    },
    {
        "id": "keep_cool_lille",
        "name": "Keep Cool Lille",
        "chain": "Keep Cool",
        "lat": 50.6365,
        "lng": 3.0635,
        "address": "89 rue du Molinel, 59000 Lille",
        "city": "Lille"
    },
    {
        "id": "fitness_park_villeneuve",
        "name": "Fitness Park Villeneuve d'Ascq",
        "chain": "Fitness Park",
        "lat": 50.6184,
        "lng": 3.1474,
        "address": "Centre Commercial V2, 59650 Villeneuve-d'Ascq",
        "city": "Villeneuve-d'Ascq"
    },
    {
        "id": "neoness_lille_flandres",
        "name": "Neoness Lille Flandres",
        "chain": "Neoness",
        "lat": 50.6372,
        "lng": 3.0700,
        "address": "Gare Lille Flandres, 59000 Lille",
        "city": "Lille"
    },
    {
        "id": "orange_bleue_tourcoing",
        "name": "L'Orange Bleue Tourcoing",
        "chain": "L'Orange Bleue",
        "lat": 50.7262,
        "lng": 3.1615,
        "address": "132 rue de Tournai, 59200 Tourcoing",
        "city": "Tourcoing"
    },

    # RHÔNE (69) - Lyon et région
    {
        "id": "basic_fit_lyon_part_dieu",
    ...
    {
        "id": "fitness_park_lyon",
        "name": "Fitness Park Lyon",
        "chain": "Fitness Park",
        "lat": 45.7489,
        "lng": 4.8467,
        "address": "112 rue de la République, 69002 Lyon",
        "city": "Lyon"
    },
    {
        "id": "cmg_lyon_bellecour",
        "name": "CMG Sports Club Lyon Bellecour",
        "chain": "CMG Sports Club",
        "lat": 45.7578,
        "lng": 4.8320,
    ...
    {
        "id": "neoness_lyon_perrache",
        "name": "Neoness Lyon Perrache",
        "chain": "Neoness",
        "lat": 45.7494,
        "lng": 4.8265,
        "address": "Gare de Perrache, 69002 Lyon",
        "city": "Lyon"
    },

    # BOUCHES-DU-RHÔNE (13) - Marseille et région
    {
        "id": "basic_fit_marseille_centre",
        "name": "Basic-Fit Marseille Centre",
        "chain": "Basic-Fit",
        "lat": 43.2965,
        "lng": 5.3698,
        "address": "47 La Canebière, 13001 Marseille",
        "city": "Marseille"
    },
    {
        "id": "keep_cool_marseille",
        "name": "Keep Cool Marseille",
        "chain": "Keep Cool",
        "lat": 43.3047,
        "lng": 5.3806,
        "address": "232 avenue du Prado, 13008 Marseille",
        "city": "Marseille"
    },
    {
        "id": "fitness_park_marseille",
        "name": "Fitness Park Marseille",
        "chain": "Fitness Park",
        "lat": 43.2922,
        "lng": 5.3656,
        "address": "Centre Bourse, 13001 Marseille",
        "city": "Marseille"
    },
    {
        "id": "orange_bleue_aix",
        ...
        "lat": 43.5263,
        "lng": 5.4454,
        "address": "765 avenue de la Grande Bégude, 13100 Aix-en-Provence",
        "city": "Aix-en-Provence"
    },

    # HAUTE-GARONNE (31) - Toulouse et région
    {
        "id": "basic_fit_toulouse_centre",
        "name": "Basic-Fit Toulouse Centre",
        "chain": "Basic-Fit",
        "lat": 43.6047,
        "lng": 1.4442,
        "address": "39 rue d'Alsace-Lorraine, 31000 Toulouse",
        "city": "Toulouse"
    },
    {
        "id": "keep_cool_toulouse",
        "name": "Keep Cool Toulouse",
        "chain": "Keep Cool",
        "lat": 43.6108,
        "lng": 1.4544,
        "address": "123 avenue de Muret, 31300 Toulouse",
        "city": "Toulouse"
    },
    {
        "id": "fitness_park_toulouse",
        "name": "Fitness Park Toulouse",
        "chain": "Fitness Park",
        "lat": 43.6029,
        "lng": 1.4486,
        "address": "Centre Commercial Saint-Georges, 31000 Toulouse",
        "city": "Toulouse"
    },

    # LOIRE-ATLANTIQUE (44) - Nantes et région
    {
        "id": "basic_fit_nantes_centre",
        "name": "Basic-Fit Nantes Centre",
        "chain": "Basic-Fit",
        "lat": 47.2184,
        "lng": -1.5536,
    ...
    {
        "id": "keep_cool_nantes",
        "name": "Keep Cool Nantes",
        "chain": "Keep Cool",
        "lat": 47.2073,
        "lng": -1.5334,
        "address": "8 boulevard de Berlin, 44000 Nantes",
        "city": "Nantes"
    },
    {
        "id": "fitness_park_nantes",
        "name": "Fitness Park Nantes",
        "chain": "Fitness Park",
        "lat": 47.2159,
        "lng": -1.5541,
        "address": "Centre Commercial Beaulieu, 44000 Nantes",
        "city": "Nantes"
    }
]
...
def validate_selected_gyms(selected_gyms_str: str) -> List[str]:
    ...
    try:
        ...
        valid_gyms = [
            gym_id for gym_id in selected_gyms
            if isinstance(gym_id, str) and gym_id in VALID_GYM_IDS
        ]
...
def get_current_user(session_token: Optional[str] = Cookie(None)):
    ...
    try:
        ...
        decoded_token = jwt.decode(session_token,
        ...
        if profile:
            profile[
                "_access_token"] = session_token  # Garder le token pour les futures requêtes
            ...
            print(
                f"⚠️ Profil manquant pour utilisateur {user_id}, création automatique"
            )
            ...
            return create_profile_on_first_login(user_supabase, mock_user,
                                                 session_token)
...
def create_profile_on_first_login(user_supabase, user, access_token: str):
    ...
    try:
        ...
        response = user_supabase.table("profiles").insert(
        ...
        if response.data:
            ...
            print(
                f"✅ Profil créé automatiquement lors de la première connexion pour {user.email}"
            )
            return profile
...
async def search_coaches(request: Request,
    ...
    if supabase_anon:
        coaches = search_coaches_supabase(supabase_anon, specialty, user_lat,
                                          user_lng, radius_km)
    else:
    ...
    try:
        ...
        try:
            ...
            for city in cities_sample:
                ...
                if city_gyms:
                    sample_gyms.extend(
                        city_gyms[:10])  # Max 10 salles par ville
        ...
        if len(sample_gyms) < 20:
            sample_gyms.extend(
                GYMS_DATABASE[:30])  # Ajouter jusqu'à 30 salles locales

        print(
            f"🏋️ API /gyms: {len(sample_gyms)} salles retournées ({len([g for g in sample_gyms if 'Data ES' in g.get('source', '')])} officielles)"
        )
    ...
    try:
        ...
        if not supabase_anon:
            ...
            if email in demo_user_cache:
                selected_gyms_str = demo_user_cache[email].get(
                    "selected_gyms", "[]")
                try:
                    selected_gyms = json.loads(
                        selected_gyms_str) if selected_gyms_str else []
            ...
            response = supabase_anon.table("profiles").select(
                "selected_gyms").eq("id", user_id).execute()
...
async def save_user_gyms(request: Request, user=Depends(get_current_user)):
    ...
    try:
        ...
        if not supabase_anon:
            ...
            if email in demo_user_cache:
                demo_user_cache[email]["selected_gyms"] = json.dumps(
                    validated_gyms)
                print(
                    f"✅ Salles sauvegardées en mode démo pour {email}: {validated_gyms}"
                )
                return {
                    "success": True,
                    "message": "Salles sauvegardées avec succès"
                }
            else:
            ...
            response = supabase_anon.table("profiles").update({
                "selected_gyms":
                json.dumps(validated_gyms)
            }).eq("id", user_id).execute()

            if response.data:
                print(
                    f"✅ Salles sauvegardées en Supabase pour l'utilisateur {user_id}: {validated_gyms}"
                )
                return {
                    "success": True,
                    "message": "Salles sauvegardées avec succès"
...
async def signup_submit(request: Request,
    ...
    if not is_valid_password(password):
        return templates.TemplateResponse("signup.html", {
            ...
            request,
            "error":
            "Mot de passe trop faible (minimum 8 caractères, 1 lettre et 1 chiffre)",
            "full_name":
            full_name,
            "email":
            email,
    ...
    if not supabase_anon:
        ...
        if role == "client":
            ...
            if selected_gyms and not selected_gyms_list:
                ...
                print(
                    f"⚠️ Salles invalides reçues pour {email}: {selected_gyms}"
                )
                return templates.TemplateResponse(
                    "signup.html", {
                        "request": request,
                        "error":
                        "Salles sélectionnées invalides. Veuillez réessayer.",
                        "full_name": full_name,
                        "email": email,
                        "gender": gender,
                        "role": role,
        ...
        demo_user_cache[email] = {
            ...
            role,
            "password":
            password,  # En production, il faudrait le hasher
            "coach_gender_preference":
            coach_gender_preference if role == "client" else None,
            "selected_gyms":
            selected_gyms_list if role == "client" else None
        }
    ...
    try:
        ...
        otp_stored = store_otp_code_for_user(supabase_anon, email, user_id,
                                             otp_code)
        ...
        if role == "client":
            ...
            validated_gyms = json.dumps(
                validated_gyms_list) if validated_gyms_list else None
        ...
        pending_stored = store_pending_registration(
            supabase_anon, email, full_name, password, role, gender,
            coach_gender_preference if role == "client" else None,
            validated_gyms)

        if not pending_stored:
            print(
                "⚠️ Attention: Les données d'inscription supplémentaires n'ont pas pu être sauvegardées"
            )
        ...
        if email_result.get("success"):
            ...
            try:
                supabase_anon.table("otp_codes").delete().eq("email",
                                                             email).execute()
...
@app.post("/verify-otp")
async def verify_otp_submit(request: Request,
                            email: str = Form(...),
                            otp_code: str = Form(...)):
    ...
    if not otp_code.isdigit() or len(otp_code) < 4 or len(otp_code) > 6:
        return templates.TemplateResponse(
            "verify_otp.html", {
                ...
                "email": email,
                "error":
                "Code invalide. Veuillez saisir un code à 4-6 chiffres."
            },
            status_code=400)
    ...
    if not supabase_anon:
        ...
        if stored_code and otp_code == stored_code:
            ...
            return templates.TemplateResponse("verify_otp.html", {
                ...
                email,
                "error":
                "Code incorrect. Veuillez utiliser le code affiché en mode démo."
            },
                                              status_code=400)
    ...
    try:
        ...
        if not pending_data:
            return templates.TemplateResponse("verify_otp.html", {
                ...
                email,
                "error":
                "Données d'inscription introuvables. Veuillez recommencer l'inscription."
            },
                                              status_code=400)

        # Récupérer l'user_id depuis otp_codes
        response = supabase_anon.table("otp_codes").select("user_id").eq(
            "email", email).eq("consumed",
        ...
        profile_created = create_user_profile_on_confirmation(
            supabase_anon, user_id, email, full_name, role, gender,
            coach_gender_preference, selected_gyms)
...
@app.post("/resend-otp")
async def resend_otp_submit(request: Request, email: str = Form(...)):
    ...
    try:
        ...
        if not pending_data:
            return templates.TemplateResponse(
                "verify_otp.html", {
                    ...
                    "email": email,
                    "error":
                    "Aucune demande d'inscription trouvée pour cet email."
                },
                status_code=400)
        ...
        otp_stored = store_otp_code(supabase_anon, email, full_name, role,
                                    new_otp_code)
...
async def coach_portal(request: Request, user=Depends(require_coach_role)):
    ...
    if user_supabase:
        transformations = get_transformations_by_coach_supabase(
            user_supabase, user["id"])
    else:
        # Mode démo
...
async def coach_portal_update(request: Request,
...
async def coach_specialties_update(request: Request,
                                   user=Depends(require_coach_role),
    ...
    user_supabase = get_supabase_client_for_user(user.get("_access_token"))
    if user_supabase:
        success = update_coach_specialties(user_supabase, user["id"],
                                           specialties)
        if not success:
            return RedirectResponse(url="/coach/portal?error=specialties",
                                    status_code=303)
...
async def coach_transformations_add(
    ...
    if not consent:
        return RedirectResponse(url="/coach/portal?error=consent",
                                status_code=303)
    ...
    if error_msg:
        return RedirectResponse(url=f"/coach/portal?error={error_msg}",
                                status_code=303)
    ...
    if user_supabase:
        try:
            ...
            transformation = add_transformation(user_supabase, user["id"],
                                                transformation_data)
            ...
            if transformation and (before_image or after_image):
                ...
                if before_image and before_image.filename:
                    ...
                    original_content, thumb_content, filename = process_image_for_upload(
                        before_content, coach_id)

                    # Upload sécurisé vers Supabase Storage
                    original_url = await upload_to_supabase_storage(
                        user_supabase, original_content,
                        f"original_{filename}")
                    thumb_url = await upload_to_supabase_storage(
                        user_supabase, thumb_content, f"thumb_{filename}")
                ...
                if error_msg:
                    return RedirectResponse(
                        url=f"/coach/portal?error={error_msg}",
                        status_code=303)

                # Mettre à jour la transformation avec les URLs
                if update_data:
                    user_supabase.table("transformations").update(
                        update_data).eq("id", transformation["id"]).execute()

        except Exception as e:
            return RedirectResponse(
                url=f"/coach/portal?error=Erreur lors de l'upload: {str(e)}",
                status_code=303)
...
async def get_coach_gym_locations(user=Depends(require_coach_role)):
    ...
    try:
        ...
        return {"success": True, "gyms": gym_relations}
...
async def add_coach_gym_location(request: Request,
                                 user=Depends(require_coach_role)):
    """
    ...
    try:
        ...
        if "gym_data" in data:
            ...
            missing_fields = [
                field for field in required_fields if field not in gym_data
            ]
            ...
            if missing_fields:
                return {
                    ...
                    False,
                    "message":
                    f"Données de salle incomplètes. Champs manquants: {', '.join(missing_fields)}"
                }
        ...
        # Format ANCIEN : query à géocoder (pour compatibilité)
            ...
            if not gym_data:
                return {
                    ...
                    False,
                    "message":
                    f"Impossible de localiser '{query}'. Vérifiez l'adresse."
                }
        ...
        # Aucun format valide
            ...
            return {
                ...
                False,
                "message":
                "Données requises: 'gym_data' (salle sélectionnée) OU 'query' (adresse à géocoder)"
            }
        ...
        if success:
            ...
            return {
                ...
                False,
                "message":
                "Cette salle est déjà dans votre liste de lieux de coaching"
            }

    except Exception as e:
        print(f"Erreur ajout lieu coach: {e}")
        return {"success": False, "message": "Erreur lors de l'ajout du lieu"}


@app.delete("/api/coach/gyms/{gym_id}")
async def remove_coach_gym_location(gym_id: str,
                                    user=Depends(require_coach_role)):
...
async def search_gyms_by_location_api(q: Optional[str] = None,
    ...
    try:
        ...
        if q:
            ...
            if zone_results:
                ...
                if geocoded:
                    results = search_gyms_by_location(geocoded["lat"],
                                                      geocoded["lng"],
                                                      radius_km)
                else:
                    # Recherche par nom dans GYMS_DATABASE si géocodage échoue
                    for gym in GYMS_DATABASE:
                        if q.lower() in gym["name"].lower() or q.lower(
                        ) in gym["address"].lower():
                            # Compter les coachs dans cette salle
                            coach_count = len(
                                get_coaches_by_gym(gym["address"]))
                            gym_result = gym.copy()
                            gym_result[
                                "distance_km"] = None  # Pas de distance si recherche par nom
            ...
            return {
                "success": False,
                "message":
                "Paramètres requis: 'q' (recherche) OU 'lat' + 'lng'",
                "gyms": []
            }

        return {"success": True, "gyms": results, "count": len(results)}
...
async def get_gym_suggestions(q: str):
    ...
    try:
        ...
        if len(suggestions) == 0:
            try:
                ...
                params_name = {
                    ...
                    20,
                    "where":
                    f'equip_nom like "%{q}%" AND (equip_type_name like "Salle de musculation" OR equip_type_name like "Salle de cours collectifs" OR equip_type_name like "Salle de culturisme" OR equip_type_name like "Salle multisports")'
                }
                ...
                if response.status_code == 200:
                    ...
                    for record in data.get("results", []):
                        ...
                        suggestion = {
                            "id":
                            f"data_es_{record.get('equip_numero', gym_name.replace(' ', '_'))}",
                            "name": gym_name,
                            ...
                            "lng": lng,
                            "chain":
                            f"Vraie salle - {record.get('equip_type_name', 'Salle de sport')}",
                ...
                print(
                    f"🏛️ API Data ES (par nom): {len(suggestions)} suggestions trouvées"
                )
        ...
        if len(suggestions) < 10:
            for gym in GYMS_DATABASE:
                if (q.lower() in gym["name"].lower()
                        or q.lower() in gym["address"].lower()
                        or q.lower() in gym.get("city", "").lower()):
